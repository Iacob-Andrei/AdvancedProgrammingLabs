...
@Entity
@NamedQuery( name = "Cities.findById", query = "SELECT c FROM CitiesEntity c WHERE c.id = :id")
@NamedQuery( name = "Cities.findByName", query = "SELECT c FROM CitiesEntity c WHERE c.name = :name")
...
public class CitiesEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "idCountry", referencedColumnName = "id2")
